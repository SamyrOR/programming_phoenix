defmodule Rumbl.AccountsTest do
  ...
  describe "register_user/1" do
    ...
    test "with invalid data does not insert user" do
      assert {:error, _changset} = Accounts.register_user(@invalid_attrs)
  ...
  describe "autheticate_by_username_and_pass/2" do
    @pass "123456"
    ...
    test "returns user with corret password", %{user: user} do
